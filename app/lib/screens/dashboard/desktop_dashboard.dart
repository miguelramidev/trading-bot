          ...
          if (_isLoading)
            ...
            ..._signals.map((s) {
              ...
              return Padding(
                ...
                child: _signalRow('Señal $dir en ${s['symbol']}', 'Algoritmo Quant', timeAgo, _getSignalStatusColor(s), onTap: () async { await context.push('/signal/${s['id']}', extra: s); _fetchDashboardData(); }),
              );
            }),
        ],
      ),
