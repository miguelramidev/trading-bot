...
const oldRsaBox = `Text('-----BEGIN PUBLIC KEY-----\\nMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8A...\\n-----END PUBLIC KEY-----', style: AppTheme.monoStyle.copyWith(color: AppColors.textSecondary, fontSize: 12))`;
const newRsaBox = `Text(_rsaPublicKey ?? 'Presiona el botón para generar...', style: AppTheme.monoStyle.copyWith(color: _rsaPublicKey != null ? AppColors.textPrimary : AppColors.textSecondary, fontSize: 12))`;
