...
* [ ] **Despliegue y Adquisición de Datos Reales (Micro-Capital):** Ejecutar operaciones de prueba con apalancamiento bajo (30-40 USDT nominales) en cuentas reales para validar el PnL calculado vs. las comisiones cobradas, y asentar métricas certeras (Expected Value R) en el reporte contable nocturno.
