...
- [x] **Filtro Institucional Anti-Exhaustión y Alineación de Medias:** Exigencia estricta de alineación `close > EMA 20 > EMA 50` para evitar falsos cruces en retrocesos, filtro de clímax de tendencia (`ADX >= 45.0`), y desactivación de operativas laterales para enfocar el 100% del capital en tendencias de alta probabilidad.
